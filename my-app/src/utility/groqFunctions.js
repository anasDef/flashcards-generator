...
/**
 * Generates flashcards by sending inputs directly to the Groq API from the client-side.
 ...
 */
export async function generateFlashcardsFromAi(youtubeLink, contentFile, instructions) {
    try {
